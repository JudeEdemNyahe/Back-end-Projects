...
SELECT item_1_id, item_1_name, item_1_price FROM store WHERE customer_id=1;
...
SELECT customer_email AS email FROM customers,orders  WHERE customers.customer_id = orders.customer_id AND orders.order_date> '2019-07-25';
